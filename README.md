home take exam answers by Eyerusaleme H/mariame Id/2860/14 bioinformatics
...
There is a plot for Q1 Task2 plot for Q1 task2.png
...
Question 3 task 1: what is the current version of miRBase?
Current version of miRBase: 22.1
Question 3 task 2:generate a plot to show which let miRNAs are present in each species
There is a plot for Q3 task2.png
...
There is a plot for Q4 task 4.png
...
Average Levenshtein Distance of 'let-7a' miRNAs: 8.60
 Question 5 task2: repeat for all let-7 miRNAs and plot
...
There is a plot for Q5 task 2.png
we work together with Melak,Bestelot,Desu